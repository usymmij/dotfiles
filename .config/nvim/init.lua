...
vim.api.nvim_create_user_command('Cpshot', '!mkdir imgs && cpshot imgs', {})
...
-- disable the annoying comment thing where new lines are comments
...
require('lazy').setup({
                    ...
                    builtin.find_files({
                        attach_mappings = function(_, map)
                            ...
                            actions.select_default:replace(function(prompt_bufnr)
                                ...
                                vim.cmd("vert diffs " .. vim.fn.fnameescape(entry.path))
                            end)
                            return true
                        end,
        ...
        config = function()
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    map('<leader>g0', require('telescope.builtin').lsp_document_symbols, 'Open Document Symbols')
    ...
    -- INDEX: autoformat with <leader> f
    {
    ...
    -- INDEX: Highlight special keyword comments
    -- FIX:
    -- TODO:
    -- NOTE:
    -- HACK:
    ...
    -- INDEX: Panel for file navigation
    {
